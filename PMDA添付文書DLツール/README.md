# PMDA 電子添文 スクレイピング＆ダウンロード統合ツール

PMDA（医薬品医療機器総合機構）の電子添文一覧ページから情報を収集し、PDF ファイルを一括ダウンロードする統合ツールです。
...
**ウィンドウタイトル**: 「PMDA 電子添文 統合ツール (設定機能付き)」

**3つのタブ**:
- **Step 1: 一覧取得** - PMDAから電子添文情報を収集
...
PMDAのウェブサイトから電子添文の一覧情報をCSVファイルとして取得します。
